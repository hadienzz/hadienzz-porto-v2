const LargeBlurBackground = ({ className }) => {
    return (
        <svg className={className} fill="none" viewBox="0 0 836 979" xmlns="http://www.w3.org/2000/svg">
            <g opacity="0.7" filter="url(#filter0_f_106_121)">
            ...
            <defs>
                <filter height="1191.91" id="filter0_f_106_121" width="1066.72" x="0.766479" y="-213.699" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    <feFlood result="BackgroundImageFix" floodOpacity="0" />
                    <feBlend result="shape" in="SourceGraphic" in2="BackgroundImageFix" />
                    <feGaussianBlur result="effect1_foregroundBlur_106_121" stdDeviation="150" />
                </filter>
            </defs>
        </svg>
