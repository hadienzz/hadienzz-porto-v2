...
const HeroSection = () => {
    return (
        <main className="px-[26px] pt-20 w-full min-h-screen">
            <article className="sm:flex gap-8 items-center lg:max-w-[1252px] mx-auto justify-between ">
                <div className="relative">

                    <div className="absolute w-[200px] h-[300px] opacity-50 blur-[100px] md:blur-[150px] rotate-[159.6deg] bg-[#831ED2] top-40 -z-40"></div>
                ...
                <div className="pt-5 relative ">
                    <div className="absolute -right-40 top-30 transform -translate-y-180 md:translate-y-0 md:right-0 md:-top-12 w-[250px] h-[400px] md:w-[400px] md:h-[500px] rotate-[158.6deg] bg-[#831ED2] opacity-70 rounded-[50%] blur-[150px] -z-100"></div>

                    <motion.blockquote className="gap-[12.5] space-y-3 lg:w-[486px]"
                        initial={{ opacity: 0, y: -60, filter: 'blur(20px)' }}
                        animate={{ opacity: 1, y: 0, filter: 'blur(0px)' }}
                        transition={{ duration: .8, delay: 0.8, ease: 'easeOut' }}
                    >
                        <div className="border-b-3 border-black md:w-10 w-[26px]"></div>
